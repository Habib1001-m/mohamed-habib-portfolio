  ...
  return (
    <div id="three-customizer" className={`flex flex-col gap-4 p-4 md:p-5 rounded-[1.5rem] bg-zinc-950/80 border border-white/10 shadow-2xl glass ${isRtl ? "font-arabic" : ""}`}>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex lg:grid lg:grid-cols-1 gap-2 overflow-x-auto lg:overflow-visible pb-1 lg:pb-0">
          {presets.map((preset) => (
            <button
              key={preset.id}
              id={`preset-${preset.id}`}
      ...
      {showAdvanced && (
        <div className="space-y-4 rounded-2xl border border-white/5 bg-black/25 p-3">
