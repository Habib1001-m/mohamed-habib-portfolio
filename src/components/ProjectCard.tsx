    ...
    >
      ...
      >
        ...
        <div className={`absolute bottom-4 ${isRtl ? "right-4" : "left-4"} flex items-center gap-2 px-2.5 py-1 bg-black/85 nav-blur rounded-md border border-white/10`}>
          ...
          <span className="font-mono text-[9px] text-slate-400 tracking-wider">PRODUCT_PROOF</span>
        </div>
      </button>

      <div className={`p-6 flex flex-col flex-1 justify-between gap-6 ${isRtl ? "text-right font-arabic" : "text-left"}`}>
        <div className="space-y-2.5">
          <h3 className="text-white font-bold text-xl tracking-tight hover:text-orange-300 transition-colors">
            {project.title[lang]}
          </h3>
