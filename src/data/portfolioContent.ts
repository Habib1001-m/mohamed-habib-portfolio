export const PORTFOLIO_DATA = {
  ...
  contact: {
    ...
    formSuccess: { en: "Message sent successfully. I’ll review it and reply as soon as possible.", ar: "تم إرسال الرسالة بنجاح. سأراجعها وأرد في أقرب وقت ممكن." },
    formError: { en: "Message could not be sent. Please try again or contact me directly by email.", ar: "تعذر إرسال الرسالة. حاول مرة أخرى أو تواصل معي مباشرة عبر البريد الإلكتروني." },
